          ...
          <div className="card scale-in bg-white/95 backdrop-blur-sm">
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Your citizen account has been successfully created. You can now access emergency services and resources.
              </p>
              <Link
                href="/login"
                className="btn w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:from-purple-700 hover:to-indigo-700"
              >
                Sign In Now
              </Link>
            </div>
        ...
        <div className="card scale-in bg-white/95 backdrop-blur-sm">
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Get access to emergency services and resources</p>
            </div>
            {error && (
